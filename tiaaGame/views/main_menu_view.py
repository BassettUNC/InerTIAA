...
class MainMenuView(arcade.View):
    ...
    def __init__(self):
        ...
        resume_button = arcade.gui.UIFlatButton(text="Resume Game", width=200, style = constants.inverse_style)
        self.v_box.add(resume_button.with_space_around(bottom=20))
        resume_button.on_click = self.on_click_resume

        settings_button = arcade.gui.UIFlatButton(text="Settings", width=200, style = constants.inverse_style)
        self.v_box.add(settings_button.with_space_around(bottom=20))
        settings_button.on_click = self.on_click_settings

        quit_button = arcade.gui.UIFlatButton(text="Quit", width=200, style = constants.inverse_style)
